      ...
      <main className="py-10">
        ...
        <div className="flex flex-row ml-10">
          <div className="pb-4 mr-4 text-center">
            <small>primary</small>
            <div className="w-20 h-20 p-2 rounded-lg bg-primary"></div>
          </div>
          <div className="pb-4 mr-4 text-center">
            <small>secondary</small>
            <div className="w-20 h-20 p-2 rounded-lg bg-secondary"></div>
          </div>
          <div className="pb-4 mr-4 text-center">
            <small>background</small>
            <div className="w-20 h-20 p-2 rounded-lg bg-background"></div>
          </div>
          <div className="pb-4 mr-4 text-center">
            <small>dark</small>
            <div className="w-20 h-20 p-2 rounded-lg bg-dark"></div>
          </div>
          <div className="pb-4 mr-4 text-center">
            <small>light</small>
            <div className="w-20 h-20 p-2 rounded-lg bg-light"></div>
          </div>
        </div>
        ...
        <div className="ml-10">
          ...
          <div className="pb-4">
            Body
          <p>
              El diseño no se trata de talento, el diseño es una habilidad, y como cualquier otra habilidad, se puede aprender.
          </p>
          </div>
        </div>
        ...
        <div className="w-2/3 ml-10">
          <Card avatar="/images/franco.jpg" name="Franco Moya" job="Product Designer & UX Strategist" />
        </div>
